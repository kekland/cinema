...
dependencies {
    ...
    implementation("androidx.media3:media3-transformer:${exoplayer_version}")
    implementation("androidx.media3:media3-effect:${exoplayer_version}")
